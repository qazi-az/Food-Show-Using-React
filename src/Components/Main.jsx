...
import { DessertsData } from '../Data/Deserts'
...
const Main = () => {
    ...
    const [showDesert, setShowDesert] = useState();
                ...
                <div className="mainTop">
                    <div className="mainNav">
                        <div className="mainNavOptions">
                            ...
                            <p className={option4 ? 'active' : 'deActive'} onClick={handleActive4}>Deserts</p>
                        </div>
